...
> **Info:** New terms get added as the platform evolves. If you see something in the UI that is not covered here, check the [Colosseum docs](../colosseum/overview.md) or the [Derek Bot docs](../token-discovery/derek-bot.md) for feature-specific terminology.
