...
> **Warning:** Always use the official domain — **onchain.cc**. Do not use links from DMs, social posts, or search ads. Bookmark the site after your first visit.
...
Click **Connect** and choose how you want to authenticate: an existing wallet (Phantom, Solflare, Backpack for Solana; MetaMask, Rabby, or any WalletConnect-compatible wallet for EVM chains), an email address, or a social login.
...
\[SCREENSHOT: Privy connect modal showing wallet, email, and social options]
...
\[SCREENSHOT: Wallet panel showing balances and deposit address]
...
\[SCREENSHOT: Trading terminal with token selected, order panel open]
